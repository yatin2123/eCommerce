  ...
  function Cart(props) {
    ...
    obj[0].name = values.name || '';
    obj[0].email = values.email || '';
    obj[0].pincode = values.pincode || '';
    obj[0].city = values.city || '';
    obj[0].state = values.state || '';
    obj[0].flat_no = values.flat_no || '';
    obj[0].landmark = values.landmark || '';
